...
== Overview
* Declare pure service traits ("effectful services") that accept a generic monad parameter
...
* Implement service trait with pure effect-free code
* Implementation is also generic for all monads and nested monads
