...
logical combination)
* Each method's return value is "lifted" into the generic monad type
...
* Implement service trait and reuse for all monads and nested monads
...
* Or use a completely different monad later without changing UserImpl
----
